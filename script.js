...
// Task 3 - change the title text
mainTitle.innerHTML = "DOM Project: Ready!";

// Task 4 - add data attribute to toggle button
...
// Task 8 - add a timestamp to the status div
...
// Tasks 5, 6, 7 - toggle the status box on click
